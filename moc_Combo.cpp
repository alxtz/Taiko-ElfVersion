...
QT_MOC_LITERAL(1, 6, 8), // "addCombo"
QT_MOC_LITERAL(2, 15, 0), // ""
QT_MOC_LITERAL(3, 16, 8) // "endCombo"

    },
    "Combo\0addCombo\0\0endCombo"
};
...
void Combo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Combo *_t = static_cast<Combo *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->addCombo(); break;
        case 1: _t->endCombo(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject Combo::staticMetaObject = {
    { &QGraphicsTextItem::staticMetaObject, qt_meta_stringdata_Combo.data,
      qt_meta_data_Combo,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Combo::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Combo.stringdata0))
        return static_cast<void*>(const_cast< Combo*>(this));
